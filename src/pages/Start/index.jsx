    ...
    return (
        <div className="container">
            <div className="flex flex-col flex-1 min-h-screen items-center justify-center">
                <div className="flex flex-col justify-center w-full max-w-[1280px] text-white px-8 md:px-10 text-justify space-y-4 font-semibold">
                ...
                <div className="bg-gray-800 text-white flex px-4 py-2 rounded-xl mt-6 gap-4 md:text-xl cursor-pointer" onClick={hasStart}>
                    <Search />
                    Pesquisar
                </div>
            </div >
